...
export const ja: TranslationDict = {
  ...
  // ── エグゼクティブサマリー ──
  "es.headline.excellent": "$MRR MRR — 力強い成長中。積極的に投資を。",
  "es.headline.good": "$MRR MRR — 基盤は堅実。最適化で成長を引き出しましょう。",
  "es.headline.fair": "$MRR MRR — シグナルが混在。強みに集中しましょう。",
  "es.headline.at_risk": "$MRR MRR — 指標が低下中。早急な対応が必要です。",
  "es.insight.qr_strong.title": "力強い成長：QR $qr倍",
  "es.insight.qr_strong.detail": "MRR $mrr、Quick Ratio $qr — 流入が流出を大幅に上回っています。",
  "es.insight.qr_treading.title": "横ばい：QR $qr倍",
  "es.insight.qr_treading.detail": "MRR $mrr は安定していますが成長なし — 新規収益と流出がほぼ同額（流入 $inflow vs 流出 $outflow）。",
  "es.insight.qr_leaking.title": "収益流出中：QR $qr倍",
  "es.insight.qr_leaking.detail": "MRR $mrr は減少中 — 毎月の流出が流入を上回っています。",
  "es.insight.top_strength.title": "最大の強み：$metricName",
  "es.insight.top_strength.detail": "$metricName は $value で、ベンチマーク $benchmark を上回っています。",
  "es.insight.critical.title": "要注意：$metricName",
  "es.insight.critical.detail": "$metricName が $value — 早急な対応が必要です。",
  "es.insight.forecast.title": "6ヶ月見通し：$projectedMRR",
  "es.insight.forecast.detail": "MRR は $currentMRR から $projectedMRR に推移する見込みです（$delta）。",
  "es.insight.best_lever.title": "最善の施策：$name",
  "es.insight.best_lever.detail": "$description により、12ヶ月以内に月額 $delta（+$deltaPercent%）の増収が見込めます。",
  "es.action.grow_funnel": "ファネルの拡大",
  "es.flywheel.layer1": "あなたのデータ",
  "es.flywheel.layer2": "同規模比較",
  "es.flywheel.layer3": "カテゴリ情報",
  "es.flywheel.layer4": "市場機会",
  "es.flywheel.unlock2": "同規模アプリのベンチマークを解除して比較しましょう",
  "es.flywheel.unlock3": "カテゴリ情報を解除して競合状況を確認しましょう",
  "es.flywheel.unlock4": "市場機会を解除して次の大きな一手を見つけましょう",
  "es.flywheel.unlocked": "すべてのインサイトレイヤーが解除されています！",
};
