...
🔗 **Video**: [Demo (1m21s, real API data)](https://github.com/sstklen/rc-insights/blob/main/demo.gif) — Terminal recording showing the tool analyzing Dark Noise's real RevenueCat data, from command to actionable recommendation.
